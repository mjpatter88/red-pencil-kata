...
class TestRedPencil(unittest.TestCase):
    ...
    def test_is_red_pencil__price_not_stable_returns_false(self):
        ...
        self.assertEqual(is_red_pencil(prices), red_pencils, "Only four days of prices should always be false.")
    ...
    def test_is_red_pencil__stable_price_25_discount_returns_true(self):
        ...
        self.assertEqual(is_red_pencil(prices), red_pencils, "Stable prices followed by 25% drop should be true.")
    ...
    def test_is_red_pencil__stable_price_5_discount_returns_true(self):
        ...
        prices.append(95)
        red_pencils.append(True)
        self.assertEqual(is_red_pencil(prices), red_pencils, "Stable prices followed by 5% drop should be true.")
    ...
    def test_is_red_pencil__stable_price_4_discount_returns_false(self):
        ...
        self.assertEqual(is_red_pencil(prices), red_pencils, "Stable prices followed by 4% drop should be false.")
    ...
    def test_is_red_pencil__stable_price_31_discount_returns_false(self):
        ...
        prices.append(69)
        red_pencils.append(False)
        self.assertEqual(is_red_pencil(prices), red_pencils, "Stable prices followed by 31% drop should be false.")
    ...
    def test_is_red_pencil__red_pencil_discount_stops_on_price_increase(self):
        ...
        self.assertEqual(is_red_pencil(prices), red_pencils, "Red pencil discount should stop when the price goes up.")
